...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="300" viewBox="0 0 1200 300">
  <defs>
    ...
    <!-- Orange radial glow behind name -->
  ...
  <g clip-path="url(#bannerClip)" opacity="0.07">
    ...
    <line x1="1200" y1="0" x2="1200" y2="300" stroke="#FF6B00" stroke-width="0.5"/>
    <!-- Horizontal lines -->
  ...
  <text
    ...
    letter-spacing="3"
    fill="#aaaaaa"
  >Full Stack Developer  •  Open Source Enthusiast  •  AI Builder</text>
